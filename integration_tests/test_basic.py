...
def test_with_symlinks():
    workspace_parent = download_project_repository("https://github.com/Dharitri-org/drt-contract-rs/archive/refs/tags/v0.0.2.zip", "test_with_symlinks")
    workspace = workspace_parent / "drt-contract-rs-0.0.2"
