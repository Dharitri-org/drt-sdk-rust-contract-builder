...
previous_builds: List[PreviousBuild] = [
    ...
    PreviousBuild(
        ...
        expected_code_hashes={
            ...
            "lottery-dct": "e06b1a5c7fb71181a79e9be6b86d8ad154e5c2def4da6d2f0aa5266163823291",
            "ping-pong-moax": "9283ca2f077edf2704053f0973fdd1eb90ee871ddcd672f962de4ba4422df84b"
        },
        docker_image="dharitriorg/sdk-rust-contract-builder:v5.4.1"
    ),
    PreviousBuild(
        name="a.4",
        project_archive_url="https://github.com/Dharitri-org/drt-contract-rs/archive/refs/tags/v0.0.1.zip",
        ...
        expected_code_hashes={
            ...
            "lottery-dct": "a54bd4278b12cc93fedd6ca0addf6aad4043528c33e54ce43cf92d4d2dd755ee",
            "ping-pong-moax": "8b107da10aef0d9610a939c4ca07c666674c465d0266fb28d5f981861f084f62"
        },
