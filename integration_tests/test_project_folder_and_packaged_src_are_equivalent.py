...
def main(cli_args: List[str]):
    # TODO: when possible, also add dharitri/drt-exchange-sc (as of May 2023, it references drt-sdk-rs < v0.41.0, thus cannot be used for testing reproducible builds v5).
    project_path = download_project_repository("https://github.com/Dharitri-org/drt-reproducible-contract-build-example-sc/archive/refs/heads/add-multisig.zip", "drt-exchange-sc-main")
